...
![Diagram illustrating the evolution from a single processing step to a chained and branched network pipeline.](man/figures/Mental Model Pipelines.png)
...
![Diagram illustrating a stateful pipeline, as a "single purpose" block](man/figures/Stateful Pipeline.png)
...
![Diagram illustrating a functional pipeline as a modularized and linear structure, where each step is cleanly seperated](man/figures/Functional Pipeline.png)
...
![Diagram illustrating a network pipeline, where each step is a node connected according to its dependencies](man/figures/Network Pipeline.png)
...
![Diagram illustrating the "collapsed" pipeline from a xafty network](man/figures/Example Sub Pipeline.png)
...
![Diagram illustrating the same pipeline introduced in step 2](man/figures/Functional Pipeline.png)
