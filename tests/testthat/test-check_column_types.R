test_that("Correct data type of check table returns true", {
  ...
  check_result <- check_column_types(check_table = check_table, validity_table = validity_table, simply = TRUE)
...
test_that("Missing column in check table does not raise an error", {
